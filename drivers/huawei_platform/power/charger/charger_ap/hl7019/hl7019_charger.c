...
static int hl7019_5v_chip_init(struct hl7019_device_info *di)
{
	...
	/* init vdpm */
	ret |= hl7019_set_dpm_voltage(VINDPM_DEFAULT);
	ret |= hl7019_write_mask(HL7019_REG_CTRL0D,
...
static int hl7019_set_charge_current(int value)
{
	...
	return hl7019_write_mask(HL7019_REG_CTRL2,
		HL7019_REG_ICHG_MASK,
		HL7019_REG_ICHG_SHIFT,
		val);
}
